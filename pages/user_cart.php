      ...
      <table class="table table-condensed table-bordered">
          ...
          ?>
              ...
              <tr>
                  ...
                  <td>     
                    <a href="edit_order_details.php?order_id=<?php echo $row['order_details_id'];?>" ><button class="btn btn-warning btn-round" type="button">Update</button></a>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                      ...
                      <option value="Syangja City">Syangja</option>
                      <option value="Butwal City">Butwal</option>
                      <option value="Baglung City">Baglung</option>
                      <option value="Hetauda City">Hetauda</option>
                      <option value="Chitwan City">Chitwan</option>
                  ...
                  <div class="modal-footer">
                    ...
                    <a><button type="submit" name="submit" class="btn btn-success btn-round"><i class="now-ui-icons shopping_delivery-fast"></i> Checkout</button></a>
...
2023                        </li>
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Ankit Pangeni.
                </div>
            </div>
        </footer>
    </div>
