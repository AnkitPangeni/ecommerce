...
<body class="index-page sidebar-collapse">
    ...
    <center>
        ...
        <br><br>
        <h3>Payment <b>success!!</b> 
        <hr color="orange"> 
        <h3> Product ID: <?php echo $_REQUEST['oid']; ?> </h3>
        <h3> Reference No.: <?php echo $_REQUEST['refId']; ?></h3>
        <h3> Amount:  <?php echo $_REQUEST['amt']; ?></h3>
        <hr color="orange"> 
        <h3><b>Thank you for shopping with us.</b></h3>
