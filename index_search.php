            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('./assets/img/ironman.jpg');">
                ...
                <div class="container">
                    <div class="content-center brand">
                        <h3>Welcome to Hamro Electronics. Where gadgets come to life...</h3>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="main">
            <div class="section section-basic">
                <div class="container">
                    <br>
                    <div class="col-md-12">
                        <center><h2 class="title">Hamro electronics products</h2></center>
                        <div>
                            <p>
...
2023                        </li>
                ...
                <div class="copyright">
                    ...
                    </script>, Designed and Coded by Ankit.
                </div>
            </div>
        </footer>
    </div>
